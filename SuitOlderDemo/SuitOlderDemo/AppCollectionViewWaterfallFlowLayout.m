...
@interface AppCollectionViewWaterfallFlowLayout ()
...
@implementation AppCollectionViewWaterfallFlowLayout

- (void)prepareLayout {
    [super prepareLayout];
    
    NSAssert(self.dataSource != nil, @"AppCollectionViewWaterfallFlowLayout.dataSource cann't be nil.");
    ...
    for (NSInteger section=0; section < numberOfSections; section++) {
        ...
        NSAssert(columnOfSection > 0, @"[AppCollectionViewWaterfallFlowLayout collectionView:layout:numberOfColumnInSection:] must be greater than 0.");
